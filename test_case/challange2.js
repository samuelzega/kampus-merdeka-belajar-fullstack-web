...
function sortCarByYearAscendingly(cars) {
    ...
    for (let index = 0; index < result.length; index++) {
        for (let index2 = 0; index2 < result.length - index - 1; index2++) {
            if (result[index2].year < result[index2 + 1].year) {
                const tmp = result[index2]
...
console.log(sortCarByYearAscendingly(input))
